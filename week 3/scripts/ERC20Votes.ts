...
async function main() {
    ...
    console.log(
        `Account ${acc1.address} has ${votes.toString()} units of voting power before self delegating\n`);
    ...
    console.log(
        `Account ${acc1.address} has ${votesAfter.toString()} units of voting power after self delegating\n`);
    ...
    console.log(
        `Account ${acc1.address} has ${votes1AfterTransfer.toString()} units of voting power after transfering\n`);
    ...
    const pastVotes1 = await contract.getPastVotes(acc1.address, blockNumber - 2);
    ...
    const pastVotes2 = await contract.getPastVotes(acc1.address, blockNumber - 3);
